...
const Products = props => {
    ...
    useEffect(() => {
        axios.get("https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/products")
        .then(res => {
    ...
    const onAddToCart = product => () => {
        ...
        axios.post("https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/user/addcart", cartItem)
        .then(res => {
            if(res.data == 'success') {
    ...
    const onDeleteProduct = product => {
        axios.delete("https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/admin/deleteProduct/" + product.productId)
        .then(res => {
            console.log("Product ",);
