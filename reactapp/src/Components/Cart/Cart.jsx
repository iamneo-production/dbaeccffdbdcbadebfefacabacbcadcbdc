...
const Cart = (props) => {
    ...
    const removeItem = productId => {
        axios.delete(`https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/user/deleteCart/${productId}/`)
        .then(res => {
    ...
    const addOrder =  () => {
        ...
        axios.post(`https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/user/addorder`, tempCartItems )
        .then(res => {
             return;
        })
        axios.delete(`https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/user/deleteallcartitems`)
                .then(res => {
    ...
    useEffect(() => {
        axios.get(`https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/user/${credentials.username}/cartitems`)
        .then(res => {
            if(res.data) {
                setState({
                    cartItems : res.data
