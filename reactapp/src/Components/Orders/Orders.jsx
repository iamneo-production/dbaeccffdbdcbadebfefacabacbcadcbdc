...
const Orders = (props) => {
    ...
    useEffect(() => {
        axios.get(`https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/user/${credentials.username}/orders`)
        .then(res => {
            if(res.data) {
    ...
    useEffect(() => {
        axios.get(`https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/getAllOrders`)
        .then(res => {
            if(res.data) {
                setState({orders : res.data});
            }
    ...
    const clearAll = () => {
        axios.delete(`https://8080-dbaeccffdbdcbadebfefacabacbcadcbdc.project.examly.io/user/deleteall`)
        .then(res => {
